...
public class StatsFile extends GameStats {
    ...
    /**
     * Generic StatsFile accepting an already parsed map
     * @param map
     */
    ...
    /**
     * Parses the data from the string array, allows testing of exceptions
     * @param limit
     * @param values
     */
    public void parseData(LocalDateTime limit, String[] values) {
        try {
